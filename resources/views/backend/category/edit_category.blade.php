        ...
        <div class="col-lg-10">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('categories.update',$categories->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" id="fname" value="{{$categories->title}}">
